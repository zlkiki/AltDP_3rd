 ...
 * Mangled: ?CHK_BBBE@CRCSCodeCheck@@QEAA_NAEBV?$CArray@II@@@Z
 * Demangled: public: bool __cdecl CRCSCodeCheck::CHK_BBBE(class CArray<unsigned int,unsigned int> const & __ptr64) __ptr64
 */
