 ...
 * Mangled: ?SMART_CHK_BWUW@CRCSCodeCheck@@QEAA_NIAEBUT_GURWO_D@@@Z
 * Demangled: public: bool __cdecl CRCSCodeCheck::SMART_CHK_BWUW(unsigned int,struct T_GURWO_D const & __ptr64) __ptr64
 */
