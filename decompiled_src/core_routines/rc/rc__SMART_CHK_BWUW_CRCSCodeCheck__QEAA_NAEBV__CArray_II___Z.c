 ...
 * Mangled: ?SMART_CHK_BWUW@CRCSCodeCheck@@QEAA_NAEBV?$CArray@II@@@Z
 * Demangled: public: bool __cdecl CRCSCodeCheck::SMART_CHK_BWUW(class CArray<unsigned int,unsigned int> const & __ptr64) __ptr64
 */
