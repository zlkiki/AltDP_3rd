 ...
 * Mangled: ?CHK_USBP@CSTLCodeCheck@@QEAA_NAEBV?$CArray@II@@@Z
 * Demangled: public: bool __cdecl CSTLCodeCheck::CHK_USBP(class CArray<unsigned int,unsigned int> const & __ptr64) __ptr64
 */
