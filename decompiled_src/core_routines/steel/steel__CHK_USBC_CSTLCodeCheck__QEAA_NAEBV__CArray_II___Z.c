 ...
 * Mangled: ?CHK_USBC@CSTLCodeCheck@@QEAA_NAEBV?$CArray@II@@@Z
 * Demangled: public: bool __cdecl CSTLCodeCheck::CHK_USBC(class CArray<unsigned int,unsigned int> const & __ptr64) __ptr64
 */
