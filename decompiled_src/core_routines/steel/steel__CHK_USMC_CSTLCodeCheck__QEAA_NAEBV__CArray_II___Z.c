 ...
 * Mangled: ?CHK_USMC@CSTLCodeCheck@@QEAA_NAEBV?$CArray@II@@@Z
 * Demangled: public: bool __cdecl CSTLCodeCheck::CHK_USMC(class CArray<unsigned int,unsigned int> const & __ptr64) __ptr64
 */
