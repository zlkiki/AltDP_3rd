 ...
 * Mangled: ?OnUpdate@CUSBPPModeDlg@@UEAAXPEAVCView@@_JPEAVCObject@@@Z
 * Demangled: public: virtual void __cdecl CUSBPPModeDlg::OnUpdate(class CView * __ptr64,__int64,class CObject * __ptr64) __ptr64
 */
