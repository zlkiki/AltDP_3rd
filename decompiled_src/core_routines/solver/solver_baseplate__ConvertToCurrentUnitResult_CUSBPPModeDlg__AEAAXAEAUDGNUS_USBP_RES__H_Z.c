 ...
 * Mangled: ?ConvertToCurrentUnitResult@CUSBPPModeDlg@@AEAAXAEAUDGNUS_USBP_RES@@H@Z
 * Demangled: private: void __cdecl CUSBPPModeDlg::ConvertToCurrentUnitResult(struct DGNUS_USBP_RES & __ptr64,int) __ptr64
 */
