 ...
 * Mangled: ?GetMessageMap@CUSBPPModeDlg@@MEBAPEBUAFX_MSGMAP@@XZ
 * Demangled: protected: virtual struct AFX_MSGMAP const * __ptr64 __cdecl CUSBPPModeDlg::GetMessageMap(void)const __ptr64
 */
