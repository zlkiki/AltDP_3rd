 ...
 * Module: DPLUS_DB.dll
 * Mangled: ??4CDBSolverTool@@QEAAAEAV0@AEBV0@@Z
 * Demangled: public: class CDBSolverTool & __ptr64 __cdecl CDBSolverTool::operator=(class CDBSolverTool const & __ptr64) __ptr64
 */
