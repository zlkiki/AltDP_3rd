 ...
 * Module: DPLUS_DB.dll
 * Mangled: ?ConvertToCurrentUnit@CDBSolverTool@@SAXW4MATLType@@AEAV?$CArray@UDGNFES_PLATE_FORCE@@AEAU1@@@@Z
 * Demangled: public: static void __cdecl CDBSolverTool::ConvertToCurrentUnit(enum MATLType,class CArray<struct DGNFES_PLATE_FORCE,struct DGNFES_PLATE_FORCE & __ptr64> & __ptr64)
 */
