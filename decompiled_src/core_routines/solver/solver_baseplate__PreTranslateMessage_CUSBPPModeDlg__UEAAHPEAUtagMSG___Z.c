 ...
 * Mangled: ?PreTranslateMessage@CUSBPPModeDlg@@UEAAHPEAUtagMSG@@@Z
 * Demangled: public: virtual int __cdecl CUSBPPModeDlg::PreTranslateMessage(struct tagMSG * __ptr64) __ptr64
 */
