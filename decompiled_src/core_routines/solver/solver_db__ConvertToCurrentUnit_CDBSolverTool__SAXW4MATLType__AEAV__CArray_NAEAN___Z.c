 ...
 * Module: DPLUS_DB.dll
 * Mangled: ?ConvertToCurrentUnit@CDBSolverTool@@SAXW4MATLType@@AEAV?$CArray@NAEAN@@@Z
 * Demangled: public: static void __cdecl CDBSolverTool::ConvertToCurrentUnit(enum MATLType,class CArray<double,double & __ptr64> & __ptr64)
 */
