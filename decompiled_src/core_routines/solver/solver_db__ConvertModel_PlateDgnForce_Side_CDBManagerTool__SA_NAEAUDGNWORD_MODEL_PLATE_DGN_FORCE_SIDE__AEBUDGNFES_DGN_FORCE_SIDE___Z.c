 ...
 * Module: DPLUS_DB.dll
 * Mangled: ?ConvertModel_PlateDgnForce_Side@CDBManagerTool@@SA_NAEAUDGNWORD_MODEL_PLATE_DGN_FORCE_SIDE@@AEBUDGNFES_DGN_FORCE_SIDE@@@Z
 * Demangled: public: static bool __cdecl CDBManagerTool::ConvertModel_PlateDgnForce_Side(struct DGNWORD_MODEL_PLATE_DGN_FORCE_SIDE & __ptr64,struct DGNFES_DGN_FORCE_SIDE const & __ptr64)
 */
