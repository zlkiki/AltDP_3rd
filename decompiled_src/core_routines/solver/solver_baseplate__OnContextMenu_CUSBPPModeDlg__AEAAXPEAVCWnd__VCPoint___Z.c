 ...
 * Mangled: ?OnContextMenu@CUSBPPModeDlg@@AEAAXPEAVCWnd@@VCPoint@@@Z
 * Demangled: private: void __cdecl CUSBPPModeDlg::OnContextMenu(class CWnd * __ptr64,class CPoint) __ptr64
 */
