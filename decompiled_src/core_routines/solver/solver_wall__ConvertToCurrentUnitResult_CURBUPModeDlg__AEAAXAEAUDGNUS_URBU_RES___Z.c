 ...
 * Mangled: ?ConvertToCurrentUnitResult@CURBUPModeDlg@@AEAAXAEAUDGNUS_URBU_RES@@@Z
 * Demangled: private: void __cdecl CURBUPModeDlg::ConvertToCurrentUnitResult(struct DGNUS_URBU_RES & __ptr64) __ptr64
 */
