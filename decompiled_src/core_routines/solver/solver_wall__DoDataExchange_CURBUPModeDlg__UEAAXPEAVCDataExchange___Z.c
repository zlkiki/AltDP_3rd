 ...
 * Mangled: ?DoDataExchange@CURBUPModeDlg@@UEAAXPEAVCDataExchange@@@Z
 * Demangled: public: virtual void __cdecl CURBUPModeDlg::DoDataExchange(class CDataExchange * __ptr64) __ptr64
 */
