 ...
 * Module: DPLUS_DB.dll
 * Mangled: ?ConvertModel_Plate@CDBManagerTool@@SA_NAEAUDGNWORD_MODEL_PLATE@@AEBUDGNFES_PLATE@@@Z
 * Demangled: public: static bool __cdecl CDBManagerTool::ConvertModel_Plate(struct DGNWORD_MODEL_PLATE & __ptr64,struct DGNFES_PLATE const & __ptr64)
 */
