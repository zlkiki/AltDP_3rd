 ...
 * Mangled: ?GetThisMessageMap@CURBUPModeDlg@@KAPEBUAFX_MSGMAP@@XZ
 * Demangled: protected: static struct AFX_MSGMAP const * __ptr64 __cdecl CURBUPModeDlg::GetThisMessageMap(void)
 */
