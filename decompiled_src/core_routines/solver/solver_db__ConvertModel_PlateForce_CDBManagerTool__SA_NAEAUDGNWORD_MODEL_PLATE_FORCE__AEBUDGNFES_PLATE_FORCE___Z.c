 ...
 * Module: DPLUS_DB.dll
 * Mangled: ?ConvertModel_PlateForce@CDBManagerTool@@SA_NAEAUDGNWORD_MODEL_PLATE_FORCE@@AEBUDGNFES_PLATE_FORCE@@@Z
 * Demangled: public: static bool __cdecl CDBManagerTool::ConvertModel_PlateForce(struct DGNWORD_MODEL_PLATE_FORCE & __ptr64,struct DGNFES_PLATE_FORCE const & __ptr64)
 */
