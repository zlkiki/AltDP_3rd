 ...
 * Mangled: ?ConvertToCurrentUnitResult@CURBUPModeDlg@@AEAAXAEAUDGNKR_URBU_RES_MODEL@@@Z
 * Demangled: private: void __cdecl CURBUPModeDlg::ConvertToCurrentUnitResult(struct DGNKR_URBU_RES_MODEL & __ptr64) __ptr64
 */
