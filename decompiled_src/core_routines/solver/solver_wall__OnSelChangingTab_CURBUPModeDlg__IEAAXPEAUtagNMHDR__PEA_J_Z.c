 ...
 * Mangled: ?OnSelChangingTab@CURBUPModeDlg@@IEAAXPEAUtagNMHDR@@PEA_J@Z
 * Demangled: protected: void __cdecl CURBUPModeDlg::OnSelChangingTab(struct tagNMHDR * __ptr64,__int64 * __ptr64) __ptr64
 */
