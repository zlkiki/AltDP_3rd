 ...
 * Mangled: ?ConvertToCurrentUnitResult@CUSBPPModeDlg@@AEAAXAEAUDGNKR_USBP_RES@@H@Z
 * Demangled: private: void __cdecl CUSBPPModeDlg::ConvertToCurrentUnitResult(struct DGNKR_USBP_RES & __ptr64,int) __ptr64
 */
