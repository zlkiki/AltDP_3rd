 ...
 * Mangled: ?PreTranslateMessage@CURBUPModeDlg@@UEAAHPEAUtagMSG@@@Z
 * Demangled: public: virtual int __cdecl CURBUPModeDlg::PreTranslateMessage(struct tagMSG * __ptr64) __ptr64
 */
