 ...
 * Mangled: ?DoDataExchange@CUSBPPModeDlg@@UEAAXPEAVCDataExchange@@@Z
 * Demangled: public: virtual void __cdecl CUSBPPModeDlg::DoDataExchange(class CDataExchange * __ptr64) __ptr64
 */
