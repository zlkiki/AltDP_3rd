 ...
 * Mangled: ?GetThisMessageMap@CUSBPPModeDlg@@KAPEBUAFX_MSGMAP@@XZ
 * Demangled: protected: static struct AFX_MSGMAP const * __ptr64 __cdecl CUSBPPModeDlg::GetThisMessageMap(void)
 */
