 ...
 * Mangled: ?OnContextMenu@CURBUPModeDlg@@IEAAXPEAVCWnd@@VCPoint@@@Z
 * Demangled: protected: void __cdecl CURBUPModeDlg::OnContextMenu(class CWnd * __ptr64,class CPoint) __ptr64
 */
