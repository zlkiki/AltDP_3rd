 ...
 * Mangled: ?OnSelChangeTab@CUSBPPModeDlg@@AEAAXPEAUtagNMHDR@@PEA_J@Z
 * Demangled: private: void __cdecl CUSBPPModeDlg::OnSelChangeTab(struct tagNMHDR * __ptr64,__int64 * __ptr64) __ptr64
 */
