 ...
 * Mangled: ?OnSelChangeTab@CURBUPModeDlg@@IEAAXPEAUtagNMHDR@@PEA_J@Z
 * Demangled: protected: void __cdecl CURBUPModeDlg::OnSelChangeTab(struct tagNMHDR * __ptr64,__int64 * __ptr64) __ptr64
 */
