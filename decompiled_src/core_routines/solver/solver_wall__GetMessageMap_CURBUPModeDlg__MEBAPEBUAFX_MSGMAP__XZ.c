 ...
 * Mangled: ?GetMessageMap@CURBUPModeDlg@@MEBAPEBUAFX_MSGMAP@@XZ
 * Demangled: protected: virtual struct AFX_MSGMAP const * __ptr64 __cdecl CURBUPModeDlg::GetMessageMap(void)const __ptr64
 */
