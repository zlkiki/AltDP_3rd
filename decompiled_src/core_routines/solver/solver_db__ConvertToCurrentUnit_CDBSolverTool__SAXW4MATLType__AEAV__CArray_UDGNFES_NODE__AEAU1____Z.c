 ...
 * Module: DPLUS_DB.dll
 * Mangled: ?ConvertToCurrentUnit@CDBSolverTool@@SAXW4MATLType@@AEAV?$CArray@UDGNFES_NODE@@AEAU1@@@@Z
 * Demangled: public: static void __cdecl CDBSolverTool::ConvertToCurrentUnit(enum MATLType,class CArray<struct DGNFES_NODE,struct DGNFES_NODE & __ptr64> & __ptr64)
 */
