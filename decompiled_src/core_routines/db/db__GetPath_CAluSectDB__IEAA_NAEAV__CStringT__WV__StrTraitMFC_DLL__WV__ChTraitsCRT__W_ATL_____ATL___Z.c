 ...
 * Module: DPLUS_DB.dll
 * Mangled: ?GetPath@CAluSectDB@@IEAA_NAEAV?$CStringT@_WV?$StrTraitMFC_DLL@_WV?$ChTraitsCRT@_W@ATL@@@@@ATL@@@Z
 * Demangled: protected: bool __cdecl CAluSectDB::GetPath(class ATL::CStringT<wchar_t,class StrTraitMFC_DLL<wchar_t,class ATL::ChTraitsCRT<wchar_t> > > & __ptr64) __ptr64
 */
