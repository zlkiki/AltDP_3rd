...
* **상위 기술 문서(SSOT)**:
  ...
  - [`docs/07_web_application_ui_ux_specification.md`](file:///f:/PyProject/AltDP_3rd/docs/07_web_application_ui_ux_specification.md) (Left-Sub 워크스페이스, 3버튼 액션 파이프라인 및 Midas 원본 다이얼로그 탭 구조)
