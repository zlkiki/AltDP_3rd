...
### Step 2: Midas 1:1 서브탭 입력폼 & 모달 (`src/web/static/js/components/form_steel_baseplate.js`)
* **Midas 원본 `IDD_STL_USBP_PMODE_DLG` 1:1 계승 서브탭 구성**:
...
* **Midas VDraw 주각부 상세도 드로잉 알고리즘 이식**:
...
- [ ] **1:1 입력폼**: Midas 원본 `IDD_STL_USBP_PMODE_DLG` 4대 서브탭 브라우저 렌더링 확인.
