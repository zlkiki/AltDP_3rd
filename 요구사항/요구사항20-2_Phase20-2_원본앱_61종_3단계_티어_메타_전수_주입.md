...
* **상위 기술 문서(SSOT)**:
  ...
  - [`docs/04_master_original_app_modules_comprehensive_catalog.md`](file:///f:/PyProject/AltDP_3rd/docs/04_master_original_app_modules_comprehensive_catalog.md) (원본앱 61종 전체 모듈 종합 카탈로그)
...
1. **Step 1 [High]**: [`docs/04`](file:///f:/PyProject/AltDP_3rd/docs/04_master_original_app_modules_comprehensive_catalog.md) 기반 61종 전수 인벤토리와 원본앱 DLG 심볼 1:1 매핑 딕셔너리 구축.
