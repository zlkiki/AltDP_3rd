# 요구사항 21: Phase V1-1 RC 보 (rc_beam) 수직 관통 마스터 명세서
...
/goal
docs 16을 확인하고, 요구사항 21과 하위 21-3의 Step 3을 구현해줘.

# [Step 4: A4 5대장구분 8단계 KaTeX 계산서 단독 실행 - High 모델 권장]
/goal
docs 16을 확인하고, 요구사항 21과 하위 21-4의 Step 4를 구현해줘.

# [Step 5: 4열 통합 E2E 검증 및 온라인 오픈 단독 실행 - Medium 모델 권장]
/goal
docs 16을 확인하고, 요구사항 21과 하위 21-5의 Step 5를 구현해줘.

# [Phase V1-01 전체 연속 완수 지시 시]
/goal
docs 16을 확인하고, 요구사항 21의 Step 1부터 Step 5까지 순차적으로 구현해줘.
```
