...
- [x] ASCE 41-17 및 Eurocode/ACI 표준 예제 대비 계산 오차 0.1% 미만.
- [x] 단위 변환 수치 정밀도 $10^{-6}$ 이내 유지.
- [x] Pytest 스위트 통과: `tests/engine/test_pbd_hinge.py`, `tests/engine/test_units.py`, `tests/engine/test_international_codes.py`, `tests/api/test_international_routes.py`.
